...
@Database(entities = [BlockedDomain::class, WhitelistedDomain::class, DnsLog::class, BlocklistUrl::class], version = 4, exportSchema = false)
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun blocklistUrlDao(): BlocklistUrlDao
